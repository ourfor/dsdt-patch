 ...
 *
 * Disassembly of SSDT-4-XMCC1604.aml, Fri Mar  6 18:20:39 2020
 *
        ...
        Device (TPM)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                If (LNotEqual (PTTB, 0xFED40040))
                {
                    ...
                    CreateDWordField (CRS0, \_SB.TPM._CRS._Y33._BAS, CBAS)  // _BAS: Base Address
                    Store (PTTB, CBAS)
                    Return (CRS0)
                }
                Else
            ...
            OperationRegion (TNVS, SystemMemory, 0x8CF6D000, 0x26)
