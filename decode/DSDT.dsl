...
DefinitionBlock ("", "DSDT", 2, "XMCC", "XMCC1604", 0x00000000)
{
    ...
    External (_SB_.PCI0.RP01.PXSX.GSPS, MethodObj)    // 1 Arguments (from opcode)
    External (_SB_.PCI0.RP01.PXSX.GSWK, MethodObj)    // 1 Arguments (from opcode)
    ...
    Method (_PTS, 1, NotSerialized)  // _PTS: Prepare To Sleep
    {
        Store (Zero, P80D)
        P8XH (Zero, Arg0)
        If (CondRefOf (\_SB.PCI0.LPCB.EC0.ECPS))
        {
            \_SB.PCI0.LPCB.EC0.ECPS (Arg0)
        }

        If (CondRefOf (\_SB.PCI0.RP01.PXSX.GSPS))
        {
            \_SB.PCI0.RP01.PXSX.GSPS (Arg0)
        }

        If (CondRefOf (\_SB.PCI0.PEG0.PEGP.GSPS))
        {
            \_SB.PCI0.PEG0.PEGP.GSPS (Arg0)
        }
    ...
    Method (_WAK, 1, Serialized)  // _WAK: Wake
    {
        ...
        If (CondRefOf (\_SB.PCI0.RP01.PXSX.GSWK))
        {
            \_SB.PCI0.RP01.PXSX.GSWK (Arg0)
        }

        If (CondRefOf (\_SB.PCI0.PEG0.PEGP.GSWK))
        {
            \_SB.PCI0.PEG0.PEGP.GSWK (Arg0)
        }
    ...
    Scope (_SB.PCI0)
    {
        ...
        Method (_INI, 0, Serialized)  // _INI: Initialize
        {
            ...
            If (CondRefOf (\_SB.PCI0.LPCB.EC0.OSIN))
            {
                ^LPCB.EC0.OSIN ()
            }
